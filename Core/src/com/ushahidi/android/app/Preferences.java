...
public class Preferences {
	...
	public static int mapZoom = 10;

	public static int totalReport = 10;
	...
	public static void loadSettings(Context context) {
		...
		mapZoom = settings.getInt("MapZoom", 10);
		totalReport = settings.getInt("TotalReport", 10);
		appRunsFirstTime = settings
				.getInt("AppRunsFirstTime", appRunsFirstTime);
		username = settings.getString("username", "");
		password = settings.getString("password", "");

		locationTolerance = Integer.parseInt(settings.getString(
				"location_tolerance_preference", "5"));
		gpsTimeout = Integer.parseInt(settings.getString(
