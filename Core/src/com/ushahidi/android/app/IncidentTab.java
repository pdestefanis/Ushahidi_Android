...
public class IncidentTab extends TabActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// set tab colors
		final int tabSelectedColor = getResources().getColor(
				R.color.tab_selected_color);
		final int tabUnselectedColor = getResources().getColor(
	...
	public void checkinEnabled() {
		...
		if (Preferences.isCheckinEnabled == 1) {
			...
			tabHost.addTab(tabHost
					...
					.setIndicator(
							getString(R.string.tab_item_report_list),
							getResources().getDrawable(
									R.drawable.tab_reports_selected))
			...
			tabHost.addTab(tabHost
					.newTabSpec("checkin")
					.setIndicator(
							getString(R.string.tab_item_report_map),
							getResources().getDrawable(
									R.drawable.tab_checkin_selected))
			...
			tabHost.addTab(tabHost
					...
					.setIndicator(
							...
							getResources().getDrawable(
									R.drawable.tab_reports_selected))
					.setContent(
							new Intent(IncidentTab.this, IncidentList.class)));
	...
	public static void setTabColor(TabHost tabhost, int selectedColor,
			int unselectedColor) {
	...
	public void onAddReport(View v) {
		...
		if (Preferences.isCheckinEnabled == 1) {
			Intent checkinActivityIntent = new Intent().setClass(
					IncidentTab.this, CheckinActivity.class);
